...
describe('USER', () => {
  ...
  describe('POST -create user', () => {
    ...
    it('should not return object of first user because the password is wrong', (done) => {
      chai.request(server)
      .post('/signup')
      .send({
        name: "Butet Silaen",
    ...
    it('should not return object of second user because the password is wrong', (done) => {
      chai.request(server)
      .post('/signup')
      .send({
        name: "Uci Arahito",
    ...
    it('should not return object of third user because the password is wrong', (done) => {
      chai.request(server)
      .post('/signup')
      .send({
        name: "Aldy Andika",
    ...
    it('should create fourth user', (done) => {
      chai.request(server)
      .post('/signup')
      .send({
        name: "Shabrina Virta",
    ...
    it('should not return object of fourth user because the password is wrong', (done) => {
      chai.request(server)
      .post('/signup')
      .send({
        name: "Shabrina Virta",
